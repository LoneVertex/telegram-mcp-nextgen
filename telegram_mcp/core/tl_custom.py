"""Custom MTProto TLRequests for Telegram features missing in upstream Telethon."""
...
class GetForumTopicsRequest(TLRequest):  # type: ignore[misc]
    ...
    async def resolve(self, client: Any, utils: Any) -> None:
    ...
    @classmethod
    def from_reader(cls, reader: Any) -> GetForumTopicsRequest:
...
class CreateForumTopicRequest(TLRequest):  # type: ignore[misc]
    ...
    @classmethod
    def from_reader(cls, reader: Any) -> CreateForumTopicRequest:
        flags = reader.read_int()
